...
echo "=== hn-wasm3-status-embedding-boundary-lab verification ==="
python3 -m py_compile "$ROOT/evaluator.py" && echo "py_compile evaluator.py: OK"
python3 -m py_compile "$ROOT/tests/test_wasm3_boundary.py" && echo "py_compile tests: OK"
echo "Running evaluator..."
python3 "$ROOT/evaluator.py"
echo "Running tests..."
python3 -m unittest tests.test_wasm3_boundary -v
